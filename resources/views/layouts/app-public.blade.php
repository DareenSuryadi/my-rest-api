...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="keywords" content="ecommerce,art">
        <meta name="author" content="422023008 - Dareen Eliezer Suryadi">

        <title>@yield('title') | 422023008 - Dareen Eliezer Suryadi</title>
